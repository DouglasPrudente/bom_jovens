...
<div id="sobrenos" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      <br><a href="C:\Users\Bruno\Desktop\Bruno\Faculdade\5º Semestre\Trabalho Projeto de Aplicação\cadastro.html"><button class="btn btn-default btn-lg">QUERO ME CADASTRAR</button></a>
    </div>
    <div class="col-sm-4">
      <img src="icone.png">
    </div>
...
<!-- Container (Portfolio Section) -->
  <h2><center> Opiniões de alguns clientes </center></h2>
